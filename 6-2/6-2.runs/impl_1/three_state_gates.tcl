...
set rc [catch {
  ...
  set_property ip_repo_paths d:/win32pe/6-2/6-2.cache/ip [current_project]
  set_property ip_output_repo d:/win32pe/6-2/6-2.cache/ip [current_project]
  add_files -quiet D:/win32pe/6-2/6-2.runs/synth_1/three_state_gates.dcp
