...
read_verilog -library xil_defaultlib D:/win32pe/6.3_1/6.3_1.srcs/sources_1/new/decoder.v
foreach dcp [get_files -quiet -all *.dcp] {
  set_property used_in_implementation false $dcp
}
read_xdc D:/win32pe/6.3_1/6.3_1.srcs/constrs_1/new/top_.xdc
set_property used_in_implementation false [get_files D:/win32pe/6.3_1/6.3_1.srcs/constrs_1/new/top_.xdc]
