...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/win32pe/6.5-3/6.5-3.cache/wt [current_project]
  set_property parent.project_path D:/win32pe/6.5-3/6.5-3.xpr [current_project]
  set_property ip_repo_paths d:/win32pe/6.5-3/6.5-3.cache/ip [current_project]
  set_property ip_output_repo d:/win32pe/6.5-3/6.5-3.cache/ip [current_project]
  add_files -quiet D:/win32pe/6.5-3/6.5-3.runs/synth_1/FA.dcp
  read_xdc D:/win32pe/6.5-3/6.5-3.srcs/constrs_1/new/tope.xdc
  link_design -top FA -part xc7a100tcsg324-1
